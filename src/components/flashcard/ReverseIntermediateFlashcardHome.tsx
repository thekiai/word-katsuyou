...
export const ReverseIntermediateFlashcardHome = () => {
  ...
  const { isLoading, getTodayStats, getOverallStats, resetProgress } = useReverseIntermediateFlashcardProgress();

  if (isStudying) {
    return <ReverseIntermediateFlashcardStudy onBack={() => setIsStudying(false)} />;
  }
